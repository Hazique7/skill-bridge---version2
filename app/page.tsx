...
function FormContent({
  ...
  return (
    <>
      ...
      <button
        type="submit"
        className="w-full h-14 mt-6 text-lg font-semibold bg-primary text-primary-foreground rounded-xl flex items-center justify-center gap-2 hover:opacity-90 transition-all"
      >
...
export default function Home() {
  ...
  // ✅ useActionState instead of useFormStatus
